...
public class DraggableItemView extends FrameLayout implements ActionDialogClick {
    ...
    public static final int STATUS_RIGHT_TOP = 0;
    public static final int STATUS_LEFT_TOP = 1;
    public static final int STATUS_LEFT_MIDDLE = 2;
...
//                    }
    ...
    public void switchPosition(int toStatus) {
        ...
        if (toStatus == STATUS_RIGHT_TOP) {
            scaleSize(SCALE_LEVEL_1);
        } else if (this.status == STATUS_RIGHT_TOP) {
    ...
    public void scaleSize(int scaleLevel) {
        ...
        if (scaleLevel == SCALE_LEVEL_1) {
            ...
            rate = smallerRate;
        }else if (scaleLevel == SCALE_LEVEL_2) {
            rate = scaleRate;
        }
    ...
    public void onDragRelease() {
        if (status == DraggableItemView.STATUS_RIGHT_TOP) {
