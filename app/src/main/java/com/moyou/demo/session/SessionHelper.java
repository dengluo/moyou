package com.moyou.demo.session;
...
import com.moyou.demo.DemoCache;
import com.moyou.demo.R;
import com.moyou.demo.contact.activity.RobotProfileActivity;
import com.moyou.demo.contact.activity.UserProfileActivity;
import com.moyou.demo.session.action.AVChatAction;
import com.moyou.demo.session.action.FileAction;
import com.moyou.demo.session.action.GuessAction;
import com.moyou.demo.session.action.RTSAction;
import com.moyou.demo.session.action.SnapChatAction;
import com.moyou.demo.session.action.TeamAVChatAction;
import com.moyou.demo.session.action.TipAction;
import com.moyou.demo.session.activity.MessageHistoryActivity;
import com.moyou.demo.session.activity.MessageInfoActivity;
import com.moyou.demo.session.extension.CustomAttachParser;
import com.moyou.demo.session.extension.CustomAttachment;
import com.moyou.demo.session.extension.GuessAttachment;
import com.moyou.demo.session.extension.RTSAttachment;
import com.moyou.demo.session.extension.RedPacketAttachment;
import com.moyou.demo.session.extension.SnapChatAttachment;
import com.moyou.demo.session.extension.StickerAttachment;
import com.moyou.demo.session.search.SearchMessageActivity;
import com.moyou.demo.session.viewholder.MsgViewHolderAVChat;
import com.moyou.demo.session.viewholder.MsgViewHolderDefCustom;
import com.moyou.demo.session.viewholder.MsgViewHolderFile;
import com.moyou.demo.session.viewholder.MsgViewHolderGuess;
import com.moyou.demo.session.viewholder.MsgViewHolderRTS;
import com.moyou.demo.session.viewholder.MsgViewHolderSnapChat;
import com.moyou.demo.session.viewholder.MsgViewHolderSticker;
import com.moyou.demo.session.viewholder.MsgViewHolderTip;
...
//                actions.insert(new RedPacketAction());
//            }
            ...
            //禁止群组按钮
            infoButton.iconId = 0;// R.drawable.nim_ic_message_actionbar_p2p_add;
