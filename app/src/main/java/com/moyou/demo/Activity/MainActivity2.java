...
import com.moyou.demo.Activity.CodeUnlockActivity;
import com.moyou.demo.Activity.EditInfoActivity2;
import com.moyou.demo.Activity.ExtensionCenterActivity;
import com.moyou.demo.Activity.FlingCardsActivity2;
import com.moyou.demo.Activity.MemberCenterActivity;
import com.moyou.demo.Activity.RouteDetailActivity;
...
import com.moyou.demo.bean.BikeInfo;
import com.moyou.demo.callback.AllInterface;
import com.moyou.demo.map.MyOrientationListener;
import com.moyou.demo.map.RouteLineAdapter;
import com.moyou.demo.overlayutil.OverlayManager;
import com.moyou.demo.overlayutil.WalkingRouteOverlay;
import com.moyou.demo.service.RouteService;
import com.moyou.demo.util.LocationManager;
import com.moyou.demo.util.NetworkUtil;
import com.moyou.demo.util.Utils;
import com.moyou.demo.view.CustomPopWindow;
import com.moyou.demo.view.RedPacketDialog;
...
import static com.moyou.demo.bean.BikeInfo.infos;
import static com.moyou.demo.util.Constant.span;

public class MainActivity2 extends BaseActivity implements View.OnClickListener, OnGetRoutePlanResultListener, AllInterface.OnMenuSlideListener {
//    @BindView(R.id.iv_index_person)
//    ImageView iv_index_person;

    private double currentLatitude, currentLongitude, changeLatitude, changeLongitude;
    private ImageView splash_img, btn_locale, btn_refresh, menu_icon, iv_index_person, iv_title_heart;
    public static TextView current_addr;
    private TextView title, book_bt, cancel_book, end_route;
    private LinearLayout bike_layout, bike_distance_layout, bike_info_layout, confirm_cancel_layout, ll_moyou_pair,ll_moyou_redpocket,ll_index_message;
    private LinearLayout ll_extension_centre;
    ...
    LatLng currentLL;
    View shadowView, leftSlidView, rightSlidView;
    private DrawerLayout drawerLayout;
    // 定位相关
    LocationClient mlocationClient;
    public MainActivity2.MyLocationListenner myListener = new MainActivity2.MyLocationListenner();
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DISMISS_SPLASH:
                    Animator animator = AnimatorInflater.loadAnimator(MainActivity2.this, R.animator.splash);
...
//        setStatusBar();
        ...
        isServiceLive = Utils.isServiceWork(this, "com.brilliant.life.service.RouteService");
        if (isServiceLive)
            beginService();
...
//        leftSlidView.setVisibility(View.VISIBLE);
    ...
    public void closeLeftSliding() {
        leftSlidView.setVisibility(View.GONE);
    }
    ...
    private void initView() {
        ...
        leftSlidView = super.findViewById(R.id.left_sliding);
...
//        leftSlidView = (View)findViewById(R.id.left_sliding);
//        rightSlidView = (View)findViewById(R.id.right_sliding);
        ...
        ll_extension_centre = (LinearLayout) findViewById(R.id.ll_extension_centre);
        ll_moyou_redpocket = (LinearLayout) findViewById(R.id.ll_moyou_redpocket);
        ll_index_message = (LinearLayout)findViewById(R.id.ll_index_message);
        ...
        ll_moyou_pair.setOnClickListener(this);
        ll_extension_centre.setOnClickListener(this);
        ll_moyou_redpocket.setOnClickListener(this);
        ll_index_message.setOnClickListener(this);
        iv_title_heart.setOnClickListener(this);
        shadowView.setOnClickListener(this);
        leftSlidView.setOnClickListener(this);
...
//        title_layout.setLayoutParams(layoutParams);
        ...
        layoutParams2.setMargins(40, statusBarHeight + Utils.dp2px(MainActivity2.this, 50), 0, 0);//4个参数按顺序分别是左上右下
...
//        mBaiduMap.setOnMapStatusChangeListener(changeListener);
        ...
        bikeIcon = BitmapDescriptorFactory.fromResource(R.mipmap.moyou_man);
    ...
    private void showPopTop(){
        ...
        popWindow .showAsDropDown(ll_moyou_redpocket,display.getWidth(),  - (ll_moyou_redpocket.getHeight() + popWindow.getHeight())+20);
//        popWindow.showAtLocation(ll_moyou_redpocket, Gravity.NO_GRAVITY,0,0);
    }
...
//              Intent intent = new Intent(MainActivity2.this, LocationDemo.class);
...
//                openMenu();
                openLeftSliding();
                break;
            case R.id.ll_moyou_pair:
                startActivity(new Intent(this, FlingCardsActivity2.class));
                break;
            case R.id.ll_extension_centre:
                startActivity(new Intent(this, ExtensionCenterActivity.class));
                break;
            case R.id.ll_moyou_redpocket:
    ...
    public void onGetWalkingRouteResult(final WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(MainActivity2.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                MainActivity2.MyTransitDlg myTransitDlg = new MainActivity2.MyTransitDlg(MainActivity2.this,
                        result.getRouteLines(),
                        RouteLineAdapter.Type.WALKING_ROUTE);
                myTransitDlg.setOnItemInDlgClickLinster(new MainActivity2.OnItemInDlgClickListener() {
                    public void onItemClick(int position) {
                        routeLine = nowResultwalk.getRouteLines().get(position);
                        WalkingRouteOverlay overlay = new MainActivity2.MyWalkingRouteOverlay(mBaiduMap);
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MainActivity2.this, "路径规划异常", Toast.LENGTH_SHORT).show();
                        }
                    }
...
//                }
                Toast.makeText(MainActivity2.this, "预约成功!", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
...
//        mBaiduMap.showInfoWindow(mInfoWindow);
    ...
    private CountDownTimer countDownTimer = new CountDownTimer(10 * 60 * 1000, 1000) {
        ...
        public void onFinish() {
            ...
            Toast.makeText(MainActivity2.this, getString(R.string.cancel_book_toast), Toast.LENGTH_SHORT).show();
        }
    };
    ...
    class MyTransitDlg extends Dialog {
        ...
        MainActivity2.OnItemInDlgClickListener onItemInDlgClickListener;
...
//                    dismiss();
        ...
        public void setOnItemInDlgClickLinster(MainActivity2.OnItemInDlgClickListener itemListener) {
...
//        startActivity(new Intent(this, NavigationActivity.class));
    ...
    protected void onStart() {
        super.onStart();
        Log.d("gaolei", "MainActivity2------------onStart------------------");
    }
    ...
    protected void onRestart() {
        ...
        mlocationClient.requestLocation();
        isServiceLive = Utils.isServiceWork(this, "com.brilliant.life.service.RouteService");
        Log.d("gaolei", "MainActivity2------------onRestart------------------");
    ...
    private void backFromRouteDetail() {
        ...
        iv_index_person.setVisibility(View.VISIBLE);
        iv_title_heart.setVisibility(View.VISIBLE);
        book_bt.setVisibility(View.VISIBLE);
    ...
    private void beginService() {
        ...
        iv_index_person.setVisibility(View.GONE);
        iv_title_heart.setVisibility(View.GONE);
    ...
    protected void onDestroy() {
        ...
        countDownTimer.cancel();
        isFirstIn = true;
        Log.d("gaolei", "MainActivity2------------onDestroy------------------");
    }

    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if (bike_layout.getVisibility() == View.VISIBLE) {
                if (!Utils.isServiceWork(this, "com.brilliant.life.service.RouteService"))
                    cancelBook();
                return true;
            }
    ...
    public static class LocationReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Utils.isTopActivity(context)) {
                ...
                Log.d("gaolei", "MainActivity2-------TopActivity---------false");
            }
        }
    }
    ...
    protected void toastDialog() {
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Intent intent = new Intent(MainActivity2.this, RouteService.class);
                stopService(intent);
            }
        });
