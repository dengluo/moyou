...
public class NimUIKit {
    ...
    private static AIUserInfoProvider AiUserInfoProvider;
    ...
    public static void setUserInfoProvider(AIUserInfoProvider userInfoProvider) {
         AiUserInfoProvider = userInfoProvider;
    }
    /**
     * 设置聊天界面的事件监听器
     *
     ...
     * <p>
     * 若需要为目标会话提供单startChatting独定义的SessionCustomization，请使用{@link NimUIKitImpl#startChatting(Context, String, SessionTypeEnum, SessionCustomization, IMMessage)}
     *
     * @param context 上下文
     * @param account 目标账号
     */
